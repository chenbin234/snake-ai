...
if torch.backends.mps.is_available():
    MODEL_PATH = r"/Users/chenbingcheng/Downloads/STUDY/06_MPICT_Courses/07_semester3/01_SSY340 Deep machine learning/snake-ai/trained_models_QRDQN_cnn_mps/QR-DQN_snake_final.zip"
else:
